    ...
    return (
        <div>
            <div className="bg-[#212529] overflow-hidden">
                <div
                    className="mx-auto flex flex-col-reverse md:flex-row max-w-[1240px] py-7 h-auto md:h-[490px] justify-between items-center">
                    <div className="flex flex-col gap-8 p-5 md:pl-10 items-start text-center md:text-left">
                        <h1 className="text-white tracking-widest text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light">
                        ...
                        <button className="bg-primary text-white font-light text-sm sm:text-base md:text-[12px] py-3 px-8 rounded-3xl mt-8
